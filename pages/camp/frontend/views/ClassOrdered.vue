<template>
  <div class="container max-w-[1000px] mx-auto">
    <div class="w-full">
      <div class="flex items-center rounded-[20px] shadow-md bg-white">
        ...
        <div class="flex items-center px-3 md:px-8 max-w-[80%]">
          <div>
            <h1 class="text-14 md:text-26 font-bold">Ramadhan Camp</h1>
            <h3 class="md:text-20 text-12 font-semibold my-1 lg:my-2">
              {{ formatCurrency(parseInt(price)) }}
            </h3>
            <p class="lg:text-14 text-sm dark-grey">
              <b>Movies Recommendation Web</b> dengan Framework <b>Vue.js</b>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="w-full items-center bg-white pb-12 lg:pb-28">
      ...
      <div class="pt-6">
        <p class="font-bold text-16 lg:text-20">Pembayaran Kamu</p>

        <div class="pt-4 lg:pt-6 grid space-y-4">
          <div class="flex justify-between">
            <p class="text-12 lg:text-16 opacity-60">
              Ramadhan Camp - <b>Movies Recommendation Web</b> dengan Framework
              <b>Vue.js</b>
            </p>
            <p class="text-12 lg:text-16 opacity-60">
              {{ formatCurrency(parseInt(200000)) }}
            </p>
          </div>
          <div class="flex justify-between">
